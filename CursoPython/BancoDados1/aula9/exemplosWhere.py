...
try:
    ...
    cursor = conn.cursor()
        ...
        funcionario = conn.consultarBanco('''
        ...
        funcionario = conn.consultarBanco(f'''
        SELECT * FROM "Funcionarios"
        WHERE "Nome" = 'Maria';
        ''')
        ...
        print("Pesquisa por salário maior:",conn.consultarBanco(f'''
        SELECT * FROM "Funcionarios"
        WHERE "Salário" > '3000'
        ORDER BY "ID"ASC; 
        '''))
        ...
        print("Pesquisa por Salário menor:",conn.consultarBanco(f'''
        SELECT * FROM "Funcionarios"
        WHERE "Salário" < '5000'
        ORDER BY "ID" ASC; 
        '''))
        ...
        print("Pesquisa por nome Maior ou Igual:",conn.consultarBanco(f'''
        SELECT * FROM "Funcionarios"
        WHERE "Nome" >= 'Maria'
        ORDER BY "ID" ASC; 
        '''))
        ...
        print("Pesquisa por salário Menor ou Igual:",conn.consultarBanco(f'''
        SELECT * FROM "Funcionarios"
        WHERE "Salário" <= '5000'
        ORDER BY "ID" ASC; 
        '''))
        ...
        print("Pesquisa por nome diferente:",conn.consultarBanco(f'''
        SELECT * FROM "Funcionarios"
        WHERE "Nome" <> 'Maria'
        ORDER BY "ID" ASC; 
        '''))
        ...
        print("Pesquisa por Salário entre valor: ",conn.consultarBanco(f'''
        SELECT * FROM "Funcionarios"
        ...
        print("Pesquisa por lista de nomes: ",conn.consultarBanco(f'''
        SELECT * FROM "Funcionarios"
        ...
        print("Pesquisa por nome: ",conn.consultarBanco(f'''
        SELECT * FROM "Funcionarios"
        WHERE "Nome" LIKE '%Mar%'
        '''))
